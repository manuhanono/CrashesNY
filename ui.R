...
shinyUI(fluidPage(theme = shinytheme("yeti"),useShinydashboard(), list(
  tags$head(
    HTML('<link rel="icon" href="nyc.svg" 
                type="image/svg" />'))),
      navbarPage(title = div(div(img(src="nyc.svg")), h5("Crashes in NY", style = "color:white")),
...
rsconnect::setAccountInfo(name='mhanono',
                          token='EA7CFC61FEF42A78059A60856768707A',
                          secret='XuAlalmZqwkxf+WC4xq1YzhIFx9MYgjK6fmRG/sE')